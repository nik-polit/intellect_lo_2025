...
var style__1 = function(feature, resolution){
    ...
    if (value >= 3.876403 && value <= 12.944789) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.944789 && value <= 21.090526) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.090526 && value <= 35.509341) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 35.509341 && value <= 88.802037) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 88.802037 && value <= 769.735632) {
            style = [ new ol.style.Style({
